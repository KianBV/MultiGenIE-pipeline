...
if __name__ == '__main__':
	...
	df_id["Preferred_Name"] = df_id["Preferred_Name"].map(df_ENS_id.set_index('Preferred_Name')['Name'])
	...
	#Remove duplicate id_organism filtes
	df_id = df_id.drop_duplicates(subset = 'Preferred_Name')
	...
	#Write in gpickle
	path_gpickle = 'C:/Users/Kian/Desktop/Kian_Praksa/IGC/databases/results/GeneMANIA/Total_network/Genome_multilayer_network.gpickle'
	ensurePathExists(path_gpickle)
	nx.write_gpickle(G,path_gpickle)

	path_edgelist = 'C:/Users/Kian/Desktop/Kian_Praksa/IGC/databases/results/GeneMANIA/Total_network/Genome_multilayer_network.edgelist'
	ensurePathExists(path_edgelist)
	nx.write_edgelist(G, path_edgelist)

	path_graphml = 'C:/Users/Kian/Desktop/Kian_Praksa/IGC/databases/results/GeneMANIA/Total_network/Genome_multilayer_network.graphml'
