...
if __name__ == '__main__':
	...
	potential_organisms = ["Homo_sapiens","Mus_musculus","Drosophila_melanogaster","Rattus_norvegicus","Danio rerio", "Caenorhabditis_elegans"]
	...
	#Remap tax IDs
	df_edges['organism'] = df_edges['organism'].map(dict_tax_id)
	...
	#Map the UniProt ID to ENSEMBL ID
	...
	df_all_ort_edges['Organism_A']=df_all_ort_edges['Gene_A'].map(df_all_id.set_index('Preferred_Name')['organism'])
	df_all_ort_edges['Organism_A']=df_all_ort_edges['Gene_B'].map(df_all_id.set_index('Preferred_Name')['organism'])
	...
	path_gpickle = 'C:/Users/Kian/Desktop/Kian_Praksa/IGC/databases/results/Mentha/Genome_network/genome_{c}_multilayer_network_TPM_cutoff_{tpm}.gpickle'.format(tpm = TPM_cutoff, c = cell_type)
	ensurePathExists(path_gpickle)
	nx.write_gpickle(G,path_gpickle)
	print("Exported the .gpickle")
	"""
	path_edgelist = 'C:/Users/Kian/Desktop/Kian_Praksa/IGC/databases/results/Mentha/Genome_network/genome_{c}_multilayer_network_TPM_cutoff_{tpm}.edgelist'.format(tpm = TPM_cutoff, c = cell_type)
	ensurePathExists(path_gpickle)
	nx.write_edgelist(G, path_edgelist)
	print("Exported the .edgelist")

	path_graphml = 'C:/Users/Kian/Desktop/Kian_Praksa/IGC/databases/results/Mentha/Genome_network/genome_{c}_multilayer_network_TPM_cutoff_{tpm}.graphml'.format(tpm = TPM_cutoff, c = cell_type)
