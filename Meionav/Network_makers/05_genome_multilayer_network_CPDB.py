...
dict_organism = dict(zip(all_organisms, organism_tax_ids))
#Map the EGGnog id
...
#Write in gpickle
path_gpickle = 'C:/Users/Kian/Desktop/Kian_Praksa/IGC/databases/results/CPDB/genome_network/Genome_Multilayer_network.gpickle'
ensurePathExists(path_gpickle)
nx.write_gpickle(G,path_gpickle)
print("Exported the .gpickle")

path_edgelist = 'C:/Users/Kian/Desktop/Kian_Praksa/IGC/databases/results/CPDB/genome_network/Genome_Multilayer_network.edgelist'
ensurePathExists(path_gpickle)
nx.write_edgelist(G, path_edgelist)
print("Exported the .edgelist")

path_graphml = 'C:/Users/Kian/Desktop/Kian_Praksa/IGC/databases/results/CPDB/genome_network/Genome_Multilayer_network.graphml'
