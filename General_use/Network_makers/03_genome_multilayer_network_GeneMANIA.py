...
if __name__ == '__main__':
	...
	df_all_ort_edges['organism_A']=df_all_ort_edges['Gene_A'].map(df_ENS_id.set_index('Preferred_Name')['organism'])
	df_all_ort_edges['organism_B']=df_all_ort_edges['Gene_B'].map(df_ENS_id.set_index('Preferred_Name')['organism'])
